...
#define WREG(a, n) MASK((SET_BITS(a, 7, 6) | SET_BITS((n - 1), 0, 6)), WREG_AND_MASK, WREG_OR_MASK)
#define RREG(a, n) MASK((SET_BITS(a, 0, 6) | SET_BITS((n - 1), 0, 6)), RREG_AND_MASK, RREG_OR_MASK)
